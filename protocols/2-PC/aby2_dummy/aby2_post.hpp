...
ABY2_POST_Share(Datatype x, Datatype l) { this->m = x; this->l = l; }
...
ABY2_POST_Share public_val(Datatype a)
{
    return ABY2_POST_Share(a,SET_ALL_ZERO());
}

ABY2_POST_Share Not() const
{
    return ABY2_POST_Share(NOT(m),l);
}
