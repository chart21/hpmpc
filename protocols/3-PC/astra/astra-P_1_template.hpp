...
public:
ASTRA1_Share()  {}
ASTRA1_Share(Datatype a, Datatype b) { mv = a; lv = b; }




ASTRA1_Share public_val(Datatype a)
{
    return ASTRA1_Share(a,SET_ALL_ZERO());
}

ASTRA1_Share Not() const
{
    return ASTRA1_Share(NOT(mv),lv);
}
