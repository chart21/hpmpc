...
class OECL0_init
{
  public:
    ...
    OECL0_init prepare_dot_a_known(OECL0_init b, func_add ADD, func_sub SUB, func_mul MULT) const
    {
        return OECL0_init();
    }
    ...
    void prepare_opt_bit_injection_with_trunc(OECL0_init x[], OECL0_init out[], Datatype trunc_factor, int fractional_bits = FRACTIONAL)
    {
