...
class OECL0_POST_Share
{
  ...
  public:
    ...
    OECL0_POST_Share prepare_div_exp2(const Datatype b, func_mul MULT, func_add ADD, func_sub SUB, func_trunc TRUNC)
        const
    {
    ...
    OECL0_POST_Share mult_a_known_to_evaluators(const OECL0_POST_Share b,
                                                func_mul MULT) const
    {
        return OECL0_POST_Share();
    }
    ...
    template <typename func_mul, typename func_add, typename func_sub, typename func_trunc>
        OECL0_POST_Share local_mult_and_trunc(const Datatype b,
                                        func_mul MULT,
                                        func_add ADD,
                                        func_sub SUB,
                                        func_trunc TRUNC,
