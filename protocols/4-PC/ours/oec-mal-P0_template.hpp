...
{
#if PRE == 1
DATATYPE result = SUB(a.v, pre_receive_from_live(P3));
/* send_to_live(P3, result); */
#else
DATATYPE result = SUB(a.v, receive_from_live(P3));
#endif
...
if(id == PSELF)
{
    ...
    send_to_live(P1,ADD(a[i].v, a[i].r));
    send_to_live(P2,ADD( a[i].v, a[i].r));
    } 
}
else if(id == P1)
{
