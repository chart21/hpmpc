...
void prepare_trunc_2k_inputs(func_add ADD, func_sub SUB, func_xor XOR, func_and AND, func_trunc trunc, OEC_MAL1_init& r_mk2, OEC_MAL1_init& r_msb, OEC_MAL1_init& c, OEC_MAL1_init& c_prime, int fractional_bits = FRACTIONAL) const{
    store_compare_view_init(P_0);
    store_compare_view_init(P_0);
}
...
OEC_MAL1_init prepare_trunc_exact_xmod2t(func_add ADD, func_sub SUB, func_xor XOR, func_and AND, int fractional_bits = FRACTIONAL) const {
    return OEC_MAL1_init();
}
...
OEC_MAL1_init prepare_mult_public_fixed(const Datatype b, func_mul MULT, func_add ADD, func_sub SUB, func_trunc TRUNC, int fractional_bits = FRACTIONAL) const
{
    store_compare_view_init(P_0);
    return OEC_MAL1_init();
}
...
template <typename func_mul, typename func_add, typename func_sub, typename func_trunc>
OEC_MAL1_init prepare_trunc_share(func_mul MULT, func_add ADD, func_sub SUB, func_trunc TRUNC, int fractional_bits = FRACTIONAL) const
{
    store_compare_view_init(P_0);
    return OEC_MAL1_init();
}
