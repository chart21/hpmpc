...
static OECL_MAL3_POST_Share public_val(Datatype a)
{
...
OECL_MAL3_POST_Share prepare_div_exp2(const Datatype b, func_mul MULT, func_add ADD, func_sub SUB, func_trunc TRUNC) const
{
    return OECL_MAL3_POST_Share();
} 
...
template <typename func_add, typename func_sub, typename func_xor, typename func_and, typename func_trunc>
void complete_trunc_2k_inputs(func_add ADD, func_sub SUB, func_xor XOR, func_and AND, func_trunc trunc, OECL_MAL3_POST_Share& r_mk2, OECL_MAL3_POST_Share& r_msb, OECL_MAL3_POST_Share& c, OECL_MAL3_POST_Share& c_prime) const{
}
