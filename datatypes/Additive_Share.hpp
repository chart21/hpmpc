...
class Additive_Share : public Share_Type
{
  public:
    ...
    void prepare_trunc_2k_inputs(Share_Type& rmk2,
                                 Share_Type& rmsb,
                                 Share_Type& c,
                                 Share_Type& c_prime,
    ...
    void prepare_XOR(const Additive_Share& a, const Additive_Share& b) { *this = a.prepare_mult(b); }
    ...
    void join_dots(Additive_Share<Datatype, Share_Type> b[]) { Share_Type::join_dots(b, OP_ADD, OP_SUB); }
#endif
...
#else
#if PROTOCOL == 2
        Share_Type::mask_and_send_dot(OP_SUB,
                                      OP_MULT);  // Replicated needs custom overloads because division by 3 is required
#else
    ...
    Share_Type get_share() const { return (Share_Type) * this; }

    void set_share(const Share_Type& s) { *this = Additive_Share(s); }
