...
CONFIG_OPTIONS := PROTOCOL PRE PARTY BITLENGTH FRACTIONAL FUNCTION_IDENTIFIER NUM_INPUTS \
				  ...
				  USE_SSL \
				  AB2_TRIPLES CONV_TRIPLES FC_TRIPLES BN2D_TRIPLES CHEETAH_THREADS \
				...
				FUSE_DOT INTERLEAVE_COMM FUSE_RELU_AVG FUSE_RELU_MAX FUSE_CONV_BN_SIM OPTIMIZED_BIT_INJECTION_RELU \
