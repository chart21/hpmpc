...
CONFIG_OPTIONS := PROTOCOL PRE PARTY BITLENGTH FRACTIONAL FUNCTION_IDENTIFIER NUM_INPUTS \
				  ...
				  USE_SSL CV_FIX\
				  A_KNOWN CONV_TRIPLES FC_TRIPLES BN2D_TRIPLES CHEETAH_THREADS CHEETAH_WAN_OPT CHEETAH_CONV_TYPE CHEETAH_DISCONNECT CHEETAH_BOOL_OT_TYPE ADDITIONAL_GEMM_THREADS\
