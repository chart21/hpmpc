...
# Base flags
EXECFLAGS := -march=native -g -fsanitize=address -fno-finite-math-only -std=c++20 -pthread -Wno-ignored-attributes
...
CONFIG_OPTIONS := PROTOCOL PRE PARTY BITLENGTH FRACTIONAL FUNCTION_IDENTIFIER NUM_INPUTS \
				  ...
				  USE_SSL \
				  AB2_TRIPLES CONV_TRIPLES FC_TRIPLES BN2D_TRIPLES \
