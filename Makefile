...
CONFIG_OPTIONS := PROTOCOL PRE PARTY BITLENGTH FRACTIONAL FUNCTION_IDENTIFIER NUM_INPUTS \
				  ...
				  USE_SSL \
				  A_KNOWN CONV_TRIPLES FC_TRIPLES BN2D_TRIPLES CHEETAH_THREADS \
				...
				A2B_ROUND_OPT_SIM A2B_ONLINE_OPT A_KNOWN_TO_EVALUATORS_OPT BIT_INJECTION_PREPROCESSING_OPT \
