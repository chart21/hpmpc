...
CONFIG_OPTIONS := PROTOCOL PRE PARTY BITLENGTH FRACTIONAL FUNCTION_IDENTIFIER NUM_INPUTS \
				  ...
				  MODELOWNER DATAOWNER TRUNC_THEN_MULT TRUNC_APPROACH TRUNC_DELAYED VERIFY_CORRECTNESS DEBUG_A2B COMPUTE_ARGMAX PUBLIC_WEIGHTS COMPRESS REDUCED_BITLENGTH_k REDUCED_BITLENGTH_m \
				...
				RESHARE_OPT_SIM PPA4_MSB PPA_MSB RCA_MSB BIT_INJECTION_TRUNC_SIM \
