...
#g++\ -march=native\ -O3\ -std=c++20\ -pthread\ -lssl\ -lcrypto\ main.cpp\ -I\ SimpleNN\ -o\ nn.o
    ...
    flags="-march=native -Ofast -fno-finite-math-only -std=c++2a -pthread -lssl -lcrypto -I SimpleNN"
    ...
    flags="-march=native -Ofast -fno-finite-math-only -std=c++2a -pthread -I SimpleNN"
