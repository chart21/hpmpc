...
#g++\ -march=native\ -O3\ -std=c++20\ -pthread\ -lssl\ -lcrypto\ main.cpp\ -I\ SimpleNN\ -o\ nn.o
    ...
    flags="-march=native -g -Ofast -fno-finite-math-only -std=c++20 -pthread -lssl -lcrypto -I SimpleNN"
    ...
    flags="-march=native -g -Ofast -fno-finite-math-only -std=c++20 -pthread -I SimpleNN"
