...
if [ ! -z "$IP3" ]; then O_IP3="$IP3"; fi
if [ ! -z "$IP4" ]; then O_IP4="$IP4"; fi
...
if [ $O_NUM_GPUS -gt 1 ]; then
    ...
    if [ "$O_PARTY" = "3" ] || [ "$O_PARTY" = "all" ]; then
        CUDA_VISIBLE_DEVICES=$((0 % O_NUM_GPUS)) ./run-P3--1-2-3-4.o $O_IP1 $O_IP2 $O_IP4 &
        CUDA_VISIBLE_DEVICES=$((1 % O_NUM_GPUS)) ./run-P3--1-3-2-4.o $O_IP1 $O_IP2 $O_IP4 &
        CUDA_VISIBLE_DEVICES=$((2 % O_NUM_GPUS)) ./run-P3--2-1-3-4.o $O_IP2 $O_IP1 $O_IP4 &
        CUDA_VISIBLE_DEVICES=$((3 % O_NUM_GPUS)) ./run-P3--2-3-1-4.o $O_IP2 $O_IP1 $O_IP4 &
        CUDA_VISIBLE_DEVICES=$((4 % O_NUM_GPUS)) ./run-P3--3-1-2-4.o $O_IP1 $O_IP2 $O_IP4 &
        CUDA_VISIBLE_DEVICES=$((5 % O_NUM_GPUS)) ./run-P3--3-2-1-4.o $O_IP2 $O_IP1 $O_IP4 &
        CUDA_VISIBLE_DEVICES=$((6 % O_NUM_GPUS)) ./run-P3--1-2-4-3.o $O_IP1 $O_IP2 $O_IP4 &
        CUDA_VISIBLE_DEVICES=$((7 % O_NUM_GPUS)) ./run-P3--1-4-2-3.o $O_IP1 $O_IP4 $O_IP2 &
        CUDA_VISIBLE_DEVICES=$((8 % O_NUM_GPUS)) ./run-P3--2-1-4-3.o $O_IP2 $O_IP1 $O_IP4 &
        CUDA_VISIBLE_DEVICES=$((9 % O_NUM_GPUS)) ./run-P3--2-4-1-3.o $O_IP2 $O_IP4 $O_IP1 &
        CUDA_VISIBLE_DEVICES=$((10 % O_NUM_GPUS)) ./run-P3--4-1-2-3.o $O_IP4 $O_IP1 $O_IP2 &
        CUDA_VISIBLE_DEVICES=$((11 % O_NUM_GPUS)) ./run-P3--4-2-1-3.o $O_IP4 $O_IP2 $O_IP1 &
        CUDA_VISIBLE_DEVICES=$((12 % O_NUM_GPUS)) ./run-P3--1-3-4-2.o $O_IP1 $O_IP4 $O_IP2 &
        CUDA_VISIBLE_DEVICES=$((13 % O_NUM_GPUS)) ./run-P3--1-4-3-2.o $O_IP1 $O_IP4 $O_IP2 &
        CUDA_VISIBLE_DEVICES=$((14 % O_NUM_GPUS)) ./run-P3--3-1-4-2.o $O_IP1 $O_IP4 $O_IP2 &
        CUDA_VISIBLE_DEVICES=$((15 % O_NUM_GPUS)) ./run-P3--3-4-1-2.o $O_IP4 $O_IP1 $O_IP2 &
        CUDA_VISIBLE_DEVICES=$((16 % O_NUM_GPUS)) ./run-P3--4-1-3-2.o $O_IP4 $O_IP1 $O_IP2 &
        CUDA_VISIBLE_DEVICES=$((17 % O_NUM_GPUS)) ./run-P3--4-3-1-2.o $O_IP4 $O_IP1 $O_IP2 &
        CUDA_VISIBLE_DEVICES=$((18 % O_NUM_GPUS)) ./run-P3--2-3-4-1.o $O_IP2 $O_IP4 $O_IP1 &
        CUDA_VISIBLE_DEVICES=$((19 % O_NUM_GPUS)) ./run-P3--2-4-3-1.o $O_IP2 $O_IP4 $O_IP1 &
        CUDA_VISIBLE_DEVICES=$((20 % O_NUM_GPUS)) ./run-P3--3-2-4-1.o $O_IP2 $O_IP4 $O_IP1 &
        CUDA_VISIBLE_DEVICES=$((21 % O_NUM_GPUS)) ./run-P3--3-4-2-1.o $O_IP4 $O_IP2 $O_IP1 &
        CUDA_VISIBLE_DEVICES=$((22 % O_NUM_GPUS)) ./run-P3--4-2-3-1.o $O_IP4 $O_IP2 $O_IP1 &
        CUDA_VISIBLE_DEVICES=$((23 % O_NUM_GPUS)) ./run-P3--4-3-2-1.o $O_IP4 $O_IP2 $O_IP1 &
    fi
else
    # Run all executables without GPU support
    if [ "$O_PARTY" = "0" ] || [ "$O_PARTY" = "all" ]; then
        ./run-P0--1-2-3-4.o $O_IP2 $O_IP3 $O_IP4 &
        ./run-P0--1-3-2-4.o $O_IP3 $O_IP2 $O_IP4 &
        ./run-P0--2-1-3-4.o $O_IP2 $O_IP3 $O_IP4 &
        ./run-P0--2-3-1-4.o $O_IP2 $O_IP3 $O_IP4 &
        ./run-P0--3-1-2-4.o $O_IP3 $O_IP2 $O_IP4 &
        ./run-P0--3-2-1-4.o $O_IP3 $O_IP2 $O_IP4 &
        ./run-P0--1-2-4-3.o $O_IP2 $O_IP4 $O_IP3 &
        ./run-P0--1-4-2-3.o $O_IP4 $O_IP2 $O_IP3 &
        ./run-P0--2-1-4-3.o $O_IP2 $O_IP4 $O_IP3 &
        ./run-P0--2-4-1-3.o $O_IP2 $O_IP4 $O_IP3 &
        ./run-P0--4-1-2-3.o $O_IP4 $O_IP2 $O_IP3 &
        ./run-P0--4-2-1-3.o $O_IP4 $O_IP2 $O_IP3 &
        ./run-P0--1-3-4-2.o $O_IP3 $O_IP4 $O_IP2 &
        ./run-P0--1-4-3-2.o $O_IP4 $O_IP3 $O_IP2 &
        ./run-P0--3-1-4-2.o $O_IP3 $O_IP4 $O_IP2 &
        ./run-P0--3-4-1-2.o $O_IP3 $O_IP4 $O_IP2 &
        ./run-P0--4-1-3-2.o $O_IP4 $O_IP3 $O_IP2 &
        ./run-P0--4-3-1-2.o $O_IP4 $O_IP3 $O_IP2 &
        ./run-P0--2-3-4-1.o $O_IP2 $O_IP3 $O_IP4 &
        ./run-P0--2-4-3-1.o $O_IP2 $O_IP4 $O_IP3 &
        ./run-P0--3-2-4-1.o $O_IP3 $O_IP2 $O_IP4 &
        ./run-P0--3-4-2-1.o $O_IP3 $O_IP4 $O_IP2 &
        ./run-P0--4-2-3-1.o $O_IP4 $O_IP2 $O_IP3 &
        ./run-P0--4-3-2-1.o $O_IP4 $O_IP3 $O_IP2 &
    fi
    if [ "$O_PARTY" = "1" ] || [ "$O_PARTY" = "all" ]; then
    ...
    if [ "$O_PARTY" = "2" ] || [ "$O_PARTY" = "all" ]; then
        ...
        ./run-P2--2-1-3-4.o $O_IP2 $O_IP1 $O_IP4 &
        ./run-P2--2-3-1-4.o $O_IP2 $O_IP1 $O_IP4 &
        ./run-P2--3-1-2-4.o $O_IP1 $O_IP2 $O_IP4 &
        ./run-P2--3-2-1-4.o $O_IP2 $O_IP1 $O_IP4 &
        ./run-P2--1-2-4-3.o $O_IP1 $O_IP2 $O_IP4 &
        ./run-P2--1-4-2-3.o $O_IP1 $O_IP4 $O_IP2 &
        ./run-P2--2-1-4-3.o $O_IP2 $O_IP1 $O_IP4 &
        ./run-P2--2-4-1-3.o $O_IP2 $O_IP4 $O_IP1 &
        ./run-P2--4-1-2-3.o $O_IP4 $O_IP1 $O_IP2 &
        ./run-P2--4-2-1-3.o $O_IP4 $O_IP2 $O_IP1 &
        ./run-P2--1-3-4-2.o $O_IP1 $O_IP4 $O_IP2 &
        ./run-P2--1-4-3-2.o $O_IP1 $O_IP4 $O_IP2 &
        ./run-P2--3-1-4-2.o $O_IP1 $O_IP4 $O_IP2 &
        ./run-P2--3-4-1-2.o $O_IP4 $O_IP1 $O_IP2 &
        ./run-P2--4-1-3-2.o $O_IP4 $O_IP1 $O_IP2 &
        ./run-P2--4-3-1-2.o $O_IP4 $O_IP1 $O_IP2 &
        ./run-P2--2-3-4-1.o $O_IP2 $O_IP3 $O_IP1 &
        ./run-P2--2-4-3-1.o $O_IP2 $O_IP4 $O_IP1 &
        ./run-P2--3-2-4-1.o $O_IP3 $O_IP2 $O_IP1 &
        ./run-P2--3-4-2-1.o $O_IP3 $O_IP4 $O_IP1 &
        ./run-P2--4-2-3-1.o $O_IP4 $O_IP2 $O_IP1 &
    ...
    if [ "$O_PARTY" = "3" ] || [ "$O_PARTY" = "all" ]; then
        ...
        ./run-P3--4-3-2-1.o $O_IP4 $O_IP3 $O_IP1 &
    fi
fi
