...
class Machine {
  public:
    ...
    inline static void execute(Machine& m, Program<int_t, cint, Share, sint, sbit, BitShare, N>& p, int arg) {
        p.run(m, arg);
    }
...
Machine<int_t, cint, Share, sint, sbit, BitShare, N>::Machine(std::string&& path) : max_mem(), loaded(false) {
...
template <class int_t, class cint, class Share, class sint, template <int, class> class sbit, class BitShare, int N>
thread& Machine<int_t, cint, Share, sint, sbit, BitShare, N>::run_tape(const unsigned& tape, const int& arg) {
    if (progs.size() <= tape)
...
template <class int_t, class cint, class Share, class sint, template <int, class> class sbit, class BitShare, int N>
void Machine<int_t, cint, Share, sint, sbit, BitShare, N>::update_max_mem(const Type& type, const unsigned& addr) {
