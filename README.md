...
scripts/run_locally.sh -n 3 # Run three parties locally
```
...
scripts/run_distributed.sh -p <party_id> -a <ip_address_party_0> -b <ip_address_party_1> -c <ip_address_party_2> -d <ip_address_party_3> # Run the MPC protocol on a distributed setup. For 3PC protocols, the -d flag has no effect.
```
...
scripts/split-roles-3-execute.sh -p <party_id> -a <ip_address_party_0> -b <ip_address_party_1> -c <ip_address_party_2> 
```
...
This projects adds support for private inference of neural networks. The following components are part of PIGEON.
