...
#elif FUNCTION_IDENTIFIER == 16 || FUNCTION_IDENTIFIER == 17 || FUNCTION_IDENTIFIER == 18 || FUNCTION_IDENTIFIER == 19 || FUNCTION_IDENTIFIER == 20 || FUNCTION_IDENTIFIER == 21
template<typename Share>
...
void AVG_BENCH(DATATYPE* res)
{
    ...
    c = c.prepare_mult_public_fixed(FloatFixedConverter<float, INT_TYPE, UINT_TYPE, FRACTIONAL>::float_to_ufixed(1.f/(float)NUM_INPUTS));
    Share::communicate();
