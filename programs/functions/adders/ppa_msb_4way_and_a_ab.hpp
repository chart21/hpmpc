...
// Zero-add gates: 20, Reshared gates: 0
    ...
    void step()
    {
        switch(level) {
            case 0:
                ...
                B3G_2_4_y1y2 = b_2_p.prepare_and(b_3_p, r46, triples[0].c);  // and_0
                // and3_1: a0=beaver3_tuples[0].a, b0=beaver3_tuples[0].b, c0=beaver3_tuples[0].c, output mask=(r30-r31)
                B3G_2_4_y1y2y3 = b_2_p_1.prepare_and3_and_assign(b_3_p_1, b_4_p, FUNC_XOR(r30, r31), beaver3_tuples[0]);  // and3_1
                // and_2: a1=triples[1].a, b1=triples[1].b, c1=triples[1].c, output mask=r47
                B3G_2_4_y2y3 = b_3_p_2.prepare_and(b_4_p_1, r47, triples[1].c);  // and_2
                // and_3: a2=triples[2].a, b2=triples[2].b, c2=triples[2].c, output mask=r48
                B3G_2_4_y1y3 = b_2_p_2.prepare_and(b_4_p_2, r48, triples[2].c);  // and_3
                // and_38: a3=triples[3].a, b3=triples[3].b, c3=triples[3].c, output mask=r56
                W3L1_5_7_y1y2 = b_5_p.prepare_and(b_6_p, r56, triples[3].c);  // and_38
                // and3_39: a1=beaver3_tuples[1].a, b1=beaver3_tuples[1].b, c1=beaver3_tuples[1].c, output mask=r57
                W3L1_5_7_y1y2y3 = b_5_p_1.prepare_and3_and_assign(b_6_p_1, b_7_p, r57, beaver3_tuples[1]);  // and3_39
                // and_40: a4=triples[4].a, b4=triples[4].b, c4=triples[4].c, output mask=r58
                W3L1_5_7_y2y3 = b_6_p_2.prepare_and(b_7_p_1, r58, triples[4].c);  // and_40
                // and_41: a5=triples[5].a, b5=triples[5].b, c5=triples[5].c, output mask=r59
                W3L1_5_7_y1y3 = b_5_p_2.prepare_and(b_7_p_2, r59, triples[5].c);  // and_41
                break;
            case 1:
                B3G_2_4_y1y2.complete_and();
                B3G_2_4_y1y2y3.complete_and3();
                B3G_2_4_y2y3.complete_and();
                B3G_2_4_y1y3.complete_and();
                W3L1_5_7_y1y2.complete_and();
                W3L1_5_7_y1y2y3.complete_and3();
                W3L1_5_7_y2y3.complete_and();
                W3L1_5_7_y1y3.complete_and();
                ...
                s1_L1.mask_and_send_dot_without_remask();
                break;
            case 2:
                s1_L1.complete_and();
...
// Zero-add gates: 60, Reshared gates: 0
template <int k, typename Share>
    ...
    void step()
    {
        switch(level) {
            case 0:
                ...
                B3G_1_3_y1y2 = b_1_p.prepare_and(b_2_p, r127, triples[0].c);  // and_0
                // and3_1: a0=beaver3_tuples[0].a, b0=beaver3_tuples[0].b, c0=beaver3_tuples[0].c, output mask=(r71-r72)
                B3G_1_3_y1y2y3 = b_1_p_1.prepare_and3_and_assign(b_2_p_1, b_3_p, FUNC_XOR(r71, r72), beaver3_tuples[0]);  // and3_1
                // and_2: a1=triples[1].a, b1=triples[1].b, c1=triples[1].c, output mask=r128
                B3G_1_3_y2y3 = b_2_p_2.prepare_and(b_3_p_1, r128, triples[1].c);  // and_2
                // and_3: a2=triples[2].a, b2=triples[2].b, c2=triples[2].c, output mask=r129
                B3G_1_3_y1y3 = b_1_p_2.prepare_and(b_3_p_2, r129, triples[2].c);  // and_3
                // and_38: a3=triples[3].a, b3=triples[3].b, c3=triples[3].c, output mask=r137
                B3G_4_6_y1y2 = b_4_p.prepare_and(b_5_p, r137, triples[3].c);  // and_38
                // and3_39: a1=beaver3_tuples[1].a, b1=beaver3_tuples[1].b, c1=beaver3_tuples[1].c, output mask=(r84-r85)
                B3G_4_6_y1y2y3 = b_4_p_1.prepare_and3_and_assign(b_5_p_1, b_6_p, FUNC_XOR(r84, r85), beaver3_tuples[1]);  // and3_39
                // and_40: a4=triples[4].a, b4=triples[4].b, c4=triples[4].c, output mask=r138
                B3G_4_6_y2y3 = b_5_p_2.prepare_and(b_6_p_1, r138, triples[4].c);  // and_40
                // and_41: a5=triples[5].a, b5=triples[5].b, c5=triples[5].c, output mask=r139
                B3G_4_6_y1y3 = b_4_p_2.prepare_and(b_6_p_2, r139, triples[5].c);  // and_41
                // and_76: a6=triples[6].a, b6=triples[6].b, c6=triples[6].c, output mask=r147
                B3G_7_9_y1y2 = b_7_p.prepare_and(b_8_p, r147, triples[6].c);  // and_76
                // and3_77: a2=beaver3_tuples[2].a, b2=beaver3_tuples[2].b, c2=beaver3_tuples[2].c, output mask=(r97-r98)
                B3G_7_9_y1y2y3 = b_7_p_1.prepare_and3_and_assign(b_8_p_1, b_9_p, FUNC_XOR(r97, r98), beaver3_tuples[2]);  // and3_77
                // and_78: a7=triples[7].a, b7=triples[7].b, c7=triples[7].c, output mask=r148
                B3G_7_9_y2y3 = b_8_p_2.prepare_and(b_9_p_1, r148, triples[7].c);  // and_78
                // and_79: a8=triples[8].a, b8=triples[8].b, c8=triples[8].c, output mask=r149
                B3G_7_9_y1y3 = b_7_p_2.prepare_and(b_9_p_2, r149, triples[8].c);  // and_79
                // and_114: a9=triples[9].a, b9=triples[9].b, c9=triples[9].c, output mask=r157
                B3G_10_12_y1y2 = b_10_p.prepare_and(b_11_p, r157, triples[9].c);  // and_114
                // and3_115: a3=beaver3_tuples[3].a, b3=beaver3_tuples[3].b, c3=beaver3_tuples[3].c, output mask=r158
                B3G_10_12_y1y2y3 = b_10_p_1.prepare_and3_and_assign(b_11_p_1, b_12_p, r158, beaver3_tuples[3]);  // and3_115
                // and_116: a10=triples[10].a, b10=triples[10].b, c10=triples[10].c, output mask=r159
                B3G_10_12_y2y3 = b_11_p_2.prepare_and(b_12_p_1, r159, triples[10].c);  // and_116
                // and_117: a11=triples[11].a, b11=triples[11].b, c11=triples[11].c, output mask=r160
                B3G_10_12_y1y3 = b_10_p_2.prepare_and(b_12_p_2, r160, triples[11].c);  // and_117
                // and_135: a12=triples[12].a, b12=triples[12].b, c12=triples[12].c, output mask=r165
                W3L1_13_15_y1y2 = b_13_p.prepare_and(b_14_p, r165, triples[12].c);  // and_135
                // and3_136: a4=beaver3_tuples[4].a, b4=beaver3_tuples[4].b, c4=beaver3_tuples[4].c, output mask=r166
                W3L1_13_15_y1y2y3 = b_13_p_1.prepare_and3_and_assign(b_14_p_1, b_15_p, r166, beaver3_tuples[4]);  // and3_136
                // and_137: a13=triples[13].a, b13=triples[13].b, c13=triples[13].c, output mask=r167
                W3L1_13_15_y2y3 = b_14_p_2.prepare_and(b_15_p_1, r167, triples[13].c);  // and_137
                // and_138: a14=triples[14].a, b14=triples[14].b, c14=triples[14].c, output mask=r168
                W3L1_13_15_y1y3 = b_13_p_2.prepare_and(b_15_p_2, r168, triples[14].c);  // and_138
                ...
                break;
            case 1:
                B3G_1_3_y1y2.complete_and();
                B3G_1_3_y1y2y3.complete_and3();
                B3G_1_3_y2y3.complete_and();
                B3G_1_3_y1y3.complete_and();
                B3G_4_6_y1y2.complete_and();
                B3G_4_6_y1y2y3.complete_and3();
                B3G_4_6_y2y3.complete_and();
                B3G_4_6_y1y3.complete_and();
                B3G_7_9_y1y2.complete_and();
                B3G_7_9_y1y2y3.complete_and3();
                B3G_7_9_y2y3.complete_and();
                B3G_7_9_y1y3.complete_and();
                B3G_10_12_y1y2.complete_and();
                B3G_10_12_y1y2y3.complete_and3();
                B3G_10_12_y2y3.complete_and();
                B3G_10_12_y1y3.complete_and();
                W3L1_13_15_y1y2.complete_and();
                W3L1_13_15_y1y2y3.complete_and3();
                W3L1_13_15_y2y3.complete_and();
                W3L1_13_15_y1y3.complete_and();
...
// Zero-add gates: 104, Reshared gates: 0
template <int k, typename Share>
    ...
    void step()
    {
        switch(level) {
            case 0:
                ...
                B3G_1_3_y1y2 = b_1_p.prepare_and(b_2_p, r260, triples[0].c);  // and_0
                // and3_1: a0=beaver3_tuples[0].a, b0=beaver3_tuples[0].b, c0=beaver3_tuples[0].c, output mask=(r126-r127)
                B3G_1_3_y1y2y3 = b_1_p_1.prepare_and3_and_assign(b_2_p_1, b_3_p, FUNC_XOR(r126, r127), beaver3_tuples[0]);  // and3_1
                // and_2: a1=triples[1].a, b1=triples[1].b, c1=triples[1].c, output mask=r261
                B3G_1_3_y2y3 = b_2_p_2.prepare_and(b_3_p_1, r261, triples[1].c);  // and_2
                // and_3: a2=triples[2].a, b2=triples[2].b, c2=triples[2].c, output mask=r262
                B3G_1_3_y1y3 = b_1_p_2.prepare_and(b_3_p_2, r262, triples[2].c);  // and_3
                // and_38: a3=triples[3].a, b3=triples[3].b, c3=triples[3].c, output mask=r270
                B3G_4_6_y1y2 = b_4_p.prepare_and(b_5_p, r270, triples[3].c);  // and_38
                // and3_39: a1=beaver3_tuples[1].a, b1=beaver3_tuples[1].b, c1=beaver3_tuples[1].c, output mask=(r139-r140)
                B3G_4_6_y1y2y3 = b_4_p_1.prepare_and3_and_assign(b_5_p_1, b_6_p, FUNC_XOR(r139, r140), beaver3_tuples[1]);  // and3_39
                // and_40: a4=triples[4].a, b4=triples[4].b, c4=triples[4].c, output mask=r271
                B3G_4_6_y2y3 = b_5_p_2.prepare_and(b_6_p_1, r271, triples[4].c);  // and_40
                // and_41: a5=triples[5].a, b5=triples[5].b, c5=triples[5].c, output mask=r272
                B3G_4_6_y1y3 = b_4_p_2.prepare_and(b_6_p_2, r272, triples[5].c);  // and_41
                // and_76: a6=triples[6].a, b6=triples[6].b, c6=triples[6].c, output mask=r280
                B3G_7_9_y1y2 = b_7_p.prepare_and(b_8_p, r280, triples[6].c);  // and_76
                // and3_77: a2=beaver3_tuples[2].a, b2=beaver3_tuples[2].b, c2=beaver3_tuples[2].c, output mask=(r152-r153)
                B3G_7_9_y1y2y3 = b_7_p_1.prepare_and3_and_assign(b_8_p_1, b_9_p, FUNC_XOR(r152, r153), beaver3_tuples[2]);  // and3_77
                // and_78: a7=triples[7].a, b7=triples[7].b, c7=triples[7].c, output mask=r281
                B3G_7_9_y2y3 = b_8_p_2.prepare_and(b_9_p_1, r281, triples[7].c);  // and_78
                // and_79: a8=triples[8].a, b8=triples[8].b, c8=triples[8].c, output mask=r282
                B3G_7_9_y1y3 = b_7_p_2.prepare_and(b_9_p_2, r282, triples[8].c);  // and_79
                // and_114: a9=triples[9].a, b9=triples[9].b, c9=triples[9].c, output mask=r290
                B3G_10_12_y1y2 = b_10_p.prepare_and(b_11_p, r290, triples[9].c);  // and_114
                // and3_115: a3=beaver3_tuples[3].a, b3=beaver3_tuples[3].b, c3=beaver3_tuples[3].c, output mask=(r159-r160)
                B3G_10_12_y1y2y3 = b_10_p_1.prepare_and3_and_assign(b_11_p_1, b_12_p, FUNC_XOR(r159, r160), beaver3_tuples[3]);  // and3_115
                // and_116: a10=triples[10].a, b10=triples[10].b, c10=triples[10].c, output mask=r291
                B3G_10_12_y2y3 = b_11_p_2.prepare_and(b_12_p_1, r291, triples[10].c);  // and_116
                // and_117: a11=triples[11].a, b11=triples[11].b, c11=triples[11].c, output mask=r292
                B3G_10_12_y1y3 = b_10_p_2.prepare_and(b_12_p_2, r292, triples[11].c);  // and_117
                // and_152: a12=triples[12].a, b12=triples[12].b, c12=triples[12].c, output mask=r300
                B3G_13_15_y1y2 = b_13_p.prepare_and(b_14_p, r300, triples[12].c);  // and_152
                // and3_153: a4=beaver3_tuples[4].a, b4=beaver3_tuples[4].b, c4=beaver3_tuples[4].c, output mask=(r172-r173)
                B3G_13_15_y1y2y3 = b_13_p_1.prepare_and3_and_assign(b_14_p_1, b_15_p, FUNC_XOR(r172, r173), beaver3_tuples[4]);  // and3_153
                // and_154: a13=triples[13].a, b13=triples[13].b, c13=triples[13].c, output mask=r301
                B3G_13_15_y2y3 = b_14_p_2.prepare_and(b_15_p_1, r301, triples[13].c);  // and_154
                // and_155: a14=triples[14].a, b14=triples[14].b, c14=triples[14].c, output mask=r302
                B3G_13_15_y1y3 = b_13_p_2.prepare_and(b_15_p_2, r302, triples[14].c);  // and_155
                // and_190: a15=triples[15].a, b15=triples[15].b, c15=triples[15].c, output mask=r310
                B3G_16_18_y1y2 = b_16_p.prepare_and(b_17_p, r310, triples[15].c);  // and_190
                // and3_191: a5=beaver3_tuples[5].a, b5=beaver3_tuples[5].b, c5=beaver3_tuples[5].c, output mask=(r185-r186)
                B3G_16_18_y1y2y3 = b_16_p_1.prepare_and3_and_assign(b_17_p_1, b_18_p, FUNC_XOR(r185, r186), beaver3_tuples[5]);  // and3_191
                // and_192: a16=triples[16].a, b16=triples[16].b, c16=triples[16].c, output mask=r311
                B3G_16_18_y2y3 = b_17_p_2.prepare_and(b_18_p_1, r311, triples[16].c);  // and_192
                // and_193: a17=triples[17].a, b17=triples[17].b, c17=triples[17].c, output mask=r312
                B3G_16_18_y1y3 = b_16_p_2.prepare_and(b_18_p_2, r312, triples[17].c);  // and_193
                // and_228: a18=triples[18].a, b18=triples[18].b, c18=triples[18].c, output mask=r320
                B3G_19_21_y1y2 = b_19_p.prepare_and(b_20_p, r320, triples[18].c);  // and_228
                // and3_229: a6=beaver3_tuples[6].a, b6=beaver3_tuples[6].b, c6=beaver3_tuples[6].c, output mask=(r198-r199)
                B3G_19_21_y1y2y3 = b_19_p_1.prepare_and3_and_assign(b_20_p_1, b_21_p, FUNC_XOR(r198, r199), beaver3_tuples[6]);  // and3_229
                // and_230: a19=triples[19].a, b19=triples[19].b, c19=triples[19].c, output mask=r321
                B3G_19_21_y2y3 = b_20_p_2.prepare_and(b_21_p_1, r321, triples[19].c);  // and_230
                // and_231: a20=triples[20].a, b20=triples[20].b, c20=triples[20].c, output mask=r322
                B3G_19_21_y1y3 = b_19_p_2.prepare_and(b_21_p_2, r322, triples[20].c);  // and_231
                // and_266: a21=triples[21].a, b21=triples[21].b, c21=triples[21].c, output mask=r330
                B3G_23_25_y1y2 = b_23_p.prepare_and(b_24_p, r330, triples[21].c);  // and_266
                // and3_267: a7=beaver3_tuples[7].a, b7=beaver3_tuples[7].b, c7=beaver3_tuples[7].c, output mask=(r211-r212)
                B3G_23_25_y1y2y3 = b_23_p_1.prepare_and3_and_assign(b_24_p_1, b_25_p, FUNC_XOR(r211, r212), beaver3_tuples[7]);  // and3_267
                // and_268: a22=triples[22].a, b22=triples[22].b, c22=triples[22].c, output mask=r331
                B3G_23_25_y2y3 = b_24_p_2.prepare_and(b_25_p_1, r331, triples[22].c);  // and_268
                // and_269: a23=triples[23].a, b23=triples[23].b, c23=triples[23].c, output mask=r332
                B3G_23_25_y1y3 = b_23_p_2.prepare_and(b_25_p_2, r332, triples[23].c);  // and_269
                // and_304: a24=triples[24].a, b24=triples[24].b, c24=triples[24].c, output mask=r340
                B3G_26_28_y1y2 = b_26_p.prepare_and(b_27_p, r340, triples[24].c);  // and_304
                // and3_305: a8=beaver3_tuples[8].a, b8=beaver3_tuples[8].b, c8=beaver3_tuples[8].c, output mask=(r224-r225)
                B3G_26_28_y1y2y3 = b_26_p_1.prepare_and3_and_assign(b_27_p_1, b_28_p, FUNC_XOR(r224, r225), beaver3_tuples[8]);  // and3_305
                // and_306: a25=triples[25].a, b25=triples[25].b, c25=triples[25].c, output mask=r341
                B3G_26_28_y2y3 = b_27_p_2.prepare_and(b_28_p_1, r341, triples[25].c);  // and_306
                // and_307: a26=triples[26].a, b26=triples[26].b, c26=triples[26].c, output mask=r342
                B3G_26_28_y1y3 = b_26_p_2.prepare_and(b_28_p_2, r342, triples[26].c);  // and_307
                // and_342: a27=triples[27].a, b27=triples[27].b, c27=triples[27].c, output mask=r350
                W3L1_29_31_y1y2 = b_29_p.prepare_and(b_30_p, r350, triples[27].c);  // and_342
                // and3_343: a9=beaver3_tuples[9].a, b9=beaver3_tuples[9].b, c9=beaver3_tuples[9].c, output mask=r351
                W3L1_29_31_y1y2y3 = b_29_p_1.prepare_and3_and_assign(b_30_p_1, b_31_p, r351, beaver3_tuples[9]);  // and3_343
                // and_344: a28=triples[28].a, b28=triples[28].b, c28=triples[28].c, output mask=r352
                W3L1_29_31_y2y3 = b_30_p_2.prepare_and(b_31_p_1, r352, triples[28].c);  // and_344
                // and_345: a29=triples[29].a, b29=triples[29].b, c29=triples[29].c, output mask=r353
                W3L1_29_31_y1y3 = b_29_p_2.prepare_and(b_31_p_2, r353, triples[29].c);  // and_345
                break;
            case 1:
                B3G_1_3_y1y2.complete_and();
                B3G_1_3_y1y2y3.complete_and3();
                ...
                B3G_10_12_y2y3.complete_and();
                B3G_10_12_y1y3.complete_and();
                B3G_13_15_y1y2.complete_and();
                B3G_13_15_y1y2y3.complete_and3();
                B3G_13_15_y2y3.complete_and();
                B3G_13_15_y1y3.complete_and();
                B3G_16_18_y1y2.complete_and();
                B3G_16_18_y1y2y3.complete_and3();
                B3G_16_18_y2y3.complete_and();
                B3G_16_18_y1y3.complete_and();
                B3G_19_21_y1y2.complete_and();
                B3G_19_21_y1y2y3.complete_and3();
                B3G_19_21_y2y3.complete_and();
                B3G_19_21_y1y3.complete_and();
                B3G_23_25_y1y2.complete_and();
                B3G_23_25_y1y2y3.complete_and3();
                B3G_23_25_y2y3.complete_and();
                B3G_23_25_y1y3.complete_and();
                B3G_26_28_y1y2.complete_and();
                B3G_26_28_y1y2y3.complete_and3();
                B3G_26_28_y2y3.complete_and();
                B3G_26_28_y1y3.complete_and();
                W3L1_29_31_y1y2.complete_and();
                W3L1_29_31_y1y2y3.complete_and3();
                W3L1_29_31_y2y3.complete_and();
                W3L1_29_31_y1y3.complete_and();
                B3G_1_3_t2_2 = a[2].mult_a_known_to_evaluators(B3G_1_3_y1y2);  // and_a_10
                B3P_1_3_t6 = a[3].mult_a_known_to_evaluators(B3G_1_3_y1y2);  // and_a_29
                B3G_1_3_t3_4 = a[3].mult_a_known_to_evaluators(B3G_1_3_y1y2y3);  // and_a_14
                B3G_1_3_t3_2 = B3G_1_3_x1x3.mult_a_known_to_evaluators(B3G_1_3_y2y3);  // and_a_12
                ...
                L1_W4S_s2.mask_and_send_dot_without_remask();
                break;
            case 2:
