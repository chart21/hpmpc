...
Share prepare_W5(Share g1, Share p1, Share g2, Share p2, Share g3, Share p3, Share g4, Share g5, Share p1234_1, Share p1234_2, Share p1234_3)
{
   /* return g1 ^ (p1 & g2) ^ p1.prepare_and3(p2, g3) ^ p1.prepare_and4(p2, p3, g4) ^ p1234_1.prepare_and4(p1234_2, p1234_3, g5); */
    auto val = p1.prepare_dot(g2) ^ p1.prepare_dot3(p2, g3) ^ p1.prepare_dot4(p2, p3, g4) ^ p1234_1.prepare_dot4(p1234_2, p1234_3, g5);
...
Share prepare_W4_S(Share a1, Share b1, Share g2, Share p2, Share g3, Share p3, Share g4)
{
   /* return g1 ^ (p1 & g2) ^ p1.prepare_and3(p2, g3) ^ p1.prepare_and4(p2, p3, g4); */
    auto val = a1.prepare_dot(b1) ^ (a1 ^ b1).prepare_dot(g2) ^ (a1 ^ b1).prepare_dot3(p2, g3) ^ (a1 ^ b1).prepare_dot4(p2, p3, g4);
    val.mask_and_send_dot();
    return val;
}
...
switch(level) {
    case 0:
        ...
        v.push_back( a[2].prepare_dot(b[2]) ^ (a[2] ^ b[2]).prepare_dot3(a[1], b[1]) ^ (a[2] ^ b[2]).prepare_dot4((a[1] ^ b[1]), a[0], b[0])); //G2
        v[0].mask_and_send_dot();
        v.push_back( a[6].prepare_dot(b[6]) ^ (a[6] ^ b[6]).prepare_dot3(a[5], b[5]) ^ (a[6] ^ b[6]).prepare_dot4((a[5] ^ b[5]), a[4], b[4])); //G6
        v[1].mask_and_send_dot();
        v.push_back( a[10].prepare_dot(b[10]) ^ (a[10] ^ b[10]).prepare_dot3(a[9], b[9]) ^ (a[10] ^ b[10]).prepare_dot4((a[9] ^ b[9]), a[8], b[8])); //G10
        v[2].mask_and_send_dot();
        v.push_back( a[14].prepare_dot(b[14]) ^ (a[14] ^ b[14]).prepare_dot3(a[13], b[13]) ^ (a[14] ^ b[14]).prepare_dot4((a[13] ^ b[13]), a[12], b[12])); //G14
        v[3].mask_and_send_dot();
        v.push_back( a[18].prepare_dot(b[18]) ^ (a[18] ^ b[18]).prepare_dot3(a[17], b[17]) ^ (a[18] ^ b[18]).prepare_dot4((a[17] ^ b[17]), a[16], b[16])); //G18
        v[4].mask_and_send_dot();
        v.push_back( a[22].prepare_dot(b[22]) ^ (a[22] ^ b[22]).prepare_dot3(a[21], b[21]) ^ (a[22] ^ b[22]).prepare_dot4((a[21] ^ b[21]), a[20], b[20])); //G22
        v[5].mask_and_send_dot();
        v.push_back( a[26].prepare_dot(b[26]) ^ (a[26] ^ b[26]).prepare_dot3(a[25], b[25]) ^ (a[26] ^ b[26]).prepare_dot4((a[25] ^ b[25]), a[24], b[24])); //G26
        v[6].mask_and_send_dot();
        v.push_back( a[30].prepare_dot(b[30]) ^ (a[30] ^ b[30]).prepare_dot3(a[29], b[29]) ^ (a[30] ^ b[30]).prepare_dot4((a[29] ^ b[29]), a[28], b[28])); //G30
        v[7].mask_and_send_dot();
        v.push_back( a[34].prepare_dot(b[34]) ^ (a[34] ^ b[34]).prepare_dot3(a[33], b[33]) ^ (a[34] ^ b[34]).prepare_dot4((a[33] ^ b[33]), a[32], b[32])); //G34
        v[8].mask_and_send_dot();
        v.push_back( a[38].prepare_dot(b[38]) ^ (a[38] ^ b[38]).prepare_dot3(a[37], b[37]) ^ (a[38] ^ b[38]).prepare_dot4((a[37] ^ b[37]), a[36], b[36])); //G38
        v[9].mask_and_send_dot();
        v.push_back( a[42].prepare_dot(b[42]) ^ (a[42] ^ b[42]).prepare_dot3(a[41], b[41]) ^ (a[42] ^ b[42]).prepare_dot4((a[41] ^ b[41]), a[40], b[40])); //G42
        v[10].mask_and_send_dot();
        v.push_back( a[46].prepare_dot(b[46]) ^ (a[46] ^ b[46]).prepare_dot3(a[45], b[45]) ^ (a[46] ^ b[46]).prepare_dot4((a[45] ^ b[45]), a[44], b[44])); //G46
        v[11].mask_and_send_dot();
        v.push_back( a[50].prepare_dot(b[50]) ^ (a[50] ^ b[50]).prepare_dot3(a[49], b[49]) ^ (a[50] ^ b[50]).prepare_dot4((a[49] ^ b[49]), a[48], b[48])); //G50
        v[12].mask_and_send_dot();
        v.push_back( a[54].prepare_dot(b[54]) ^ (a[54] ^ b[54]).prepare_dot3(a[53], b[53]) ^ (a[54] ^ b[54]).prepare_dot4((a[53] ^ b[53]), a[52], b[52])); //G54
        v[13].mask_and_send_dot();
        v.push_back( a[58].prepare_dot(b[58]) ^ (a[58] ^ b[58]).prepare_dot3(a[57], b[57]) ^ (a[58] ^ b[58]).prepare_dot4((a[57] ^ b[57]), a[56], b[56])); //G58
        v[14].mask_and_send_dot();
        v.push_back( a[62].prepare_dot(b[62]) ^ (a[62] ^ b[62]).prepare_dot3(a[61], b[61]) ^ (a[62] ^ b[62]).prepare_dot4((a[61] ^ b[61]), a[60], b[60])); //G62
    ...
    case 1:
{
    ...
    v.push_back(P39.prepare_dot3(a[35],b[35]) ^ P39.prepare_dot3((a[35]^b[35]), G34) ^ P39.prepare_dot4(P35,a[31],b[31]) ^ P39.prepare_dot4(P35,(a[31]^b[31]),G30)); // T1, need to add G39 when complete
    v[44].mask_and_send_dot();
    v.push_back(P55.prepare_dot3(a[51],b[51]) ^ P55.prepare_dot3((a[51]^b[51]), G50) ^ P55.prepare_dot4(P51,a[47],b[47]) ^ P55.prepare_dot4(P51,(a[47]^b[47]),G46)); // T2, need to add G55 when complete
    v[45].mask_and_send_dot();
    v.push_back(P62.prepare_dot3(a[11],b[11]) ^ P62.prepare_dot3((a[11]^b[11]), G10) ^ P62.prepare_dot4(P11,a[7],b[7]) ^ P62.prepare_dot4(P11,(a[7]^b[7]),G6) ^ P62.prepare_dot4(P11,P7,g3) ^ P62_3.prepare_dot4(P11,P7,G2));// T3, need to prepare g[3]
    v[46].mask_and_send_dot();
    v.push_back(P62.prepare_dot3(a[23],b[23]) ^ P62.prepare_dot3((a[23]^b[23]), G22) ^ P62.prepare_dot4(P23,a[19],b[19]) ^ P62.prepare_dot4(P23,g19,G18) ^ P62.prepare_dot4(P23,P19,g15) ^ P62_15.prepare_dot4(P23,P19,G14));// T4, need to prepare g[19], verify if 2nd G19 should be P19
    ...
    case 2:
{
    ...
    auto T3 = v[46];
    auto T4 = v[47];
    msb = P62.prepare_dot(G59) ^ P62.prepare_dot3(P59,T2) ^ P62.prepare_dot3(P59_2, G43) ^ P62.prepare_dot4(P59_2,P43,T1) ^ T4.prepare_dot4(P59_2,P43_2,P27) ^ P59_2.prepare_dot4(P43_2,P27_2,T3);// T4, need to prepare g[19], verify if 2nd G19 should be P19
