...
void MixColumn__ (/*inputs*/ XOR_Share<DATATYPE,Share> inp__[128][NUM_INPUTS], /*outputs*/ XOR_Share<DATATYPE,Share> out__[128][NUM_INPUTS])
{
  ...
  for (int i = 0; i < NUM_INPUTS; i++)
  {
    ...
    MixColumn_single___1__tmp17_[0][i] = MixColumn__single__1__tmp15_[0][i] ^ MixColumn__single__1_times3___2__tmp6_[0][i];
    MixColumn_single___1__tmp17_[1][i] = MixColumn__single__1__tmp15_[1][i] ^ MixColumn__single__1_times3___2__tmp6_[1][i];
    MixColumn_single___1__tmp17_[2][i] = MixColumn__single__1__tmp15_[2][i] ^ MixColumn__single__1_times3___2__tmp6_[2][i];
    MixColumn_single___1__tmp17_[3][i] = MixColumn__single__1__tmp15_[3][i] ^ MixColumn__single__1_times3___2__tmp6_[3][i];
    MixColumn_single___1__tmp17_[4][i] = MixColumn__single__1__tmp15_[4][i] ^ MixColumn__single__1_times3___2__tmp6_[4][i];
    MixColumn_single___1__tmp17_[5][i] = MixColumn__single__1__tmp15_[5][i] ^ MixColumn__single__1_times3___2__tmp6_[5][i];
    MixColumn_single____1__tmp17_[6][i] = MixColumn__single__1__tmp15_[6][i] ^ MixColumn__single__1_times3___2__tmp6_[6][i];
    MixColumn_single___1__tmp17_[7][i] = MixColumn__single__1__tmp15_[7][i] ^ MixColumn__single__1_times3___2__tmp6_[7][i];
