...
void Matrix_Operations_Tutorial(DATATYPE* res)
{
    ...
    //The Framework switches between arithemtic vectorization for arithemtic operations and Bitslicing for boolean operations. For matrix operations we also provide support for GPU acceleration.This feature is optional and can be enabled by setting USE_CUDA_GEMM to > 0.
