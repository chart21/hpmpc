...
bool test_basic_primitives(DATATYPE *res)
{
    ...
    int num_passed = 0;
    #if TEST_SECRET_SHARING == 1
    test_function(num_tests, num_passed, "Secret Sharing and Revealing, Input from P_0", test_secret_sharing_and_revealing<Share, P_0>);
    test_function(num_tests, num_passed, "Secret Sharing and Revealing, Input from P_1", test_secret_sharing_and_revealing<Share, P_1>);
    #if num_players > 2
    test_function(num_tests, num_passed, "Secret Sharing and Revealing P_2, Input from P_2", test_secret_sharing_and_revealing<Share, P_2>);
    #endif
    #if num_players > 3
    test_function(num_tests, num_passed, "Secret Sharing and Revealing P_3, Input from P_3", test_secret_sharing_and_revealing<Share, P_3>);
    #endif
    #endif
