...
#define BANDWIDTH_OPTIMIZED 1
#define ONLINE_OPTIMIZED 0
#elif FUNCTION_IDENTIFIER == 508 || FUNCTION_IDENTIFIER == 514 || FUNCTION_IDENTIFIER == 517 //PPA
#define BANDWIDTH_OPTIMIZED 0
#define ONLINE_OPTIMIZED 0
#elif FUNCTION_IDENTIFIER == 509 || FUNCTION_IDENTIFIER == 515 || FUNCTION_IDENTIFIER == 518 //PPA 4-Way
#define BANDWIDTH_OPTIMIZED 0
#define ONLINE_OPTIMIZED 1
#endif
#else
