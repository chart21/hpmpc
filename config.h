...
#define FUNCTION_IDENTIFIER 501
...
#if FUNCTION_IDENTIFIER == 507 || FUNCTION_IDENTIFIER == 513 || FUNCTION_IDENTIFIER == 516 || FUNCTION_IDENTIFIER == 521 || FUNCTION_IDENTIFIER == 526 
#define BANDWIDTH_OPTIMIZED 1
#define ONLINE_OPTIMIZED 0
#elif FUNCTION_IDENTIFIER == 508 || FUNCTION_IDENTIFIER == 514 || FUNCTION_IDENTIFIER == 517 || FUNCTION_IDENTIFIER == 522 || FUNCTION_IDENTIFIER == 527 //PPA
#define BANDWIDTH_OPTIMIZED 0
#define ONLINE_OPTIMIZED 0
#elif FUNCTION_IDENTIFIER == 509 || FUNCTION_IDENTIFIER == 515 || FUNCTION_IDENTIFIER == 518 || FUNCTION_IDENTIFIER == 523 || FUNCTION_IDENTIFIER == 528 //PPA 4-Way
#define BANDWIDTH_OPTIMIZED 0
#define ONLINE_OPTIMIZED 1
#endif
#else
