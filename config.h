...
#if FUNCTION_IDENTIFIER == 42 || FUNCTION_IDENTIFIER == 46 || FUNCTION_IDENTIFIER == 49 || FUNCTION_IDENTIFIER == 52 || FUNCTION_IDENTIFIER == 59 || FUNCTION_IDENTIFIER == 62 // RCA
...
#endif
#elif FUNCTION_IDENTIFIER == 43 || FUNCTION_IDENTIFIER == 47 || FUNCTION_IDENTIFIER == 50 || FUNCTION_IDENTIFIER == 53 || FUNCTION_IDENTIFIER == 60 || FUNCTION_IDENTIFIER == 63 // PPA
#ifndef BANDWIDTH_OPTIMIZED
...
#define ONLINE_OPTIMIZED 0
#endif
#elif FUNCTION_IDENTIFIER == 44 || FUNCTION_IDENTIFIER == 48 || FUNCTION_IDENTIFIER == 51 || FUNCTION_IDENTIFIER == 54 || FUNCTION_IDENTIFIER == 61 || FUNCTION_IDENTIFIER == 64 // PPA 4-Way
#ifndef BANDWIDTH_OPTIMIZED
#define BANDWIDTH_OPTIMIZED 0
#endif
...
#if FUNCTION_IDENTIFIER == 507 || FUNCTION_IDENTIFIER == 513 || FUNCTION_IDENTIFIER == 516 || FUNCTION_IDENTIFIER == 521 || FUNCTION_IDENTIFIER == 526 || FUNCTION_IDENTIFIER == 529 || FUNCTION_IDENTIFIER == 532
#define BANDWIDTH_OPTIMIZED 1
#define ONLINE_OPTIMIZED 0
#elif FUNCTION_IDENTIFIER == 508 || FUNCTION_IDENTIFIER == 514 || FUNCTION_IDENTIFIER == 517 || FUNCTION_IDENTIFIER == 522 || FUNCTION_IDENTIFIER == 527 || FUNCTION_IDENTIFIER == 530 || FUNCTION_IDENTIFIER == 533 //PPA
#define BANDWIDTH_OPTIMIZED 0
#define ONLINE_OPTIMIZED 0
#elif FUNCTION_IDENTIFIER == 509 || FUNCTION_IDENTIFIER == 515 || FUNCTION_IDENTIFIER == 518 || FUNCTION_IDENTIFIER == 523 || FUNCTION_IDENTIFIER == 528 || FUNCTION_IDENTIFIER == 531 || FUNCTION_IDENTIFIER == 534 //PPA 4-Way
#define BANDWIDTH_OPTIMIZED 0
#define ONLINE_OPTIMIZED 1
#endif
